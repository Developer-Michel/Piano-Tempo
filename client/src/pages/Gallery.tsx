    ...
    <div className="min-h-screen bg-white" data-testid="page-gallery">
      ...
      <main className="pt-32 pb-24" ref={sectionRef}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="font-display text-4xl md:text-5xl text-black mb-4" data-testid="text-gallery-title">
              {translations.gallery.title[language]}
            </h1>
            <p className="font-serif text-xl text-gold italic mb-4" data-testid="text-gallery-subtitle">
          ...
          >
            <p className="font-sans text-gray-600 max-w-2xl mx-auto" data-testid="text-gallery-coming-soon">
