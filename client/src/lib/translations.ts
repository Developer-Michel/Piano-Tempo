...
export const translations = {
  ...
  teachers: {
    ...
    subtitle: {
      en: "Expert Instructors Dedicated to Your Musical Journey",
      fr: "Des instructeurs experts dédiés à votre parcours musical",
    },
  ...
  testimonials: {
    ...
    items: [
      ...
      },
      {
        ...
        child: {
          en: "Father of Lucas, 12 years old",
          fr: "Père de Lucas, 12 ans",
        },
      },
      {
        quote: {
        ...
        author: {
          en: "Catherine L., Adult Student",
          fr: "Catherine L., Étudiante adulte",
        },
        child: {
          en: "Adult beginner, 45 years old",
          fr: "Débutante adulte, 45 ans",
        },
      },
    ],
  },
  contact: {
    ...
    subtitle: {
      en: "Begin Your Musical Journey Today",
      fr: "Commencez votre parcours musical aujourd'hui",
    },
    form: {
  ...
  footer: {
    tagline: {
      en: "Excellence in Piano Education",
      fr: "L'excellence en enseignement du piano",
    },
  ...
  faq: {
    ...
    items: [
      {
        q: {
          en: "What age can my child start piano lessons?",
          fr: "À quel âge mon enfant peut-il commencer les cours de piano?",
        },
        a: {
      ...
      {
        q: {
          en: "Do you prepare students for examinations?",
          fr: "Préparez-vous les élèves aux examens?",
        },
        a: {
          en: "Yes, we prepare students for Royal Conservatory of Music (RCM) examinations and other recognized certification programs. Many of our students have achieved distinction at various levels.",
          fr: "Oui, nous préparons les élèves aux examens du Conservatoire Royal de Musique (RCM) et à d'autres programmes de certification reconnus. Beaucoup de nos élèves ont obtenu des distinctions à divers niveaux.",
        },
      },
      {
        q: {
          en: "Are there performance opportunities?",
          fr: "Y a-t-il des opportunités de performance?",
        },
        a: {
  ...
  gallery: {
    ...
    subtitle: {
      en: "Moments from Our Musical Community",
      fr: "Moments de notre communauté musicale",
    },
    comingSoon: {
      en: "Photo gallery coming soon. Check back for images of our recitals, lessons, and events.",
      fr: "Galerie photo à venir. Revenez pour des images de nos récitals, cours et événements.",
    },
  },
  resources: {
    title: { en: "Resources", fr: "Ressources" },
    subtitle: {
      en: "Tools and Materials for Your Practice",
      fr: "Outils et matériaux pour votre pratique",
    },
    comingSoon: {
