...
export const translations = {
  nav: {
    ...
    teachers: { en: 'Teachers', fr: 'Professeurs' },
  ...
  hero: {
    tagline: { en: 'Where passion meets discipline', fr: 'Là où la passion rencontre la discipline' },
    cta: { en: 'Inquire Now', fr: 'Renseignez-vous' },
  },
  about: {
    title: { en: 'About Piano à Tempo', fr: 'À propos de Piano à Tempo' },
    subtitle: { en: 'Excellence in Piano Education Since 2010', fr: "L'excellence en enseignement du piano depuis 2010" },
    p1: { 
    ...
    stats: {
      ...
      years: { en: 'Years of Excellence', fr: "Années d'excellence" },
      recitals: { en: 'Annual Recitals', fr: 'Récitals annuels' },
    },
  },
  teachers: {
    title: { en: 'Our Teachers', fr: 'Nos Professeurs' },
    subtitle: { en: 'Expert Instructors Dedicated to Your Musical Journey', fr: 'Des instructeurs experts dédiés à votre parcours musical' },
    readMore: { en: 'Read More', fr: 'Lire la suite' },
    readLess: { en: 'Read Less', fr: 'Réduire' },
    teacher1: {
      name: 'Marie-Claire Dubois',
      title: { en: 'Director & Senior Instructor', fr: 'Directrice & Instructrice principale' },
      bio: {
    ...
    teacher2: {
      ...
      title: { en: 'Senior Instructor & Performance Coach', fr: 'Instructeur principal & Coach de performance' },
      bio: {
  ...
  programs: {
    title: { en: 'Our Programs', fr: 'Nos Programmes' },
    subtitle: { en: 'Tailored Instruction for Every Age and Level', fr: 'Un enseignement adapté à chaque âge et niveau' },
    ...
    group7to9: {
      title: { en: 'Group Lessons (Ages 7-9)', fr: 'Cours de groupe (7-9 ans)' },
      description: {
    ...
    group10to13: {
      title: { en: 'Group Lessons (Ages 10-13)', fr: 'Cours de groupe (10-13 ans)' },
      description: {
    ...
    group13to17: {
      title: { en: 'Group Lessons (Ages 13-17)', fr: 'Cours de groupe (13-17 ans)' },
      description: {
    ...
    adult: {
      title: { en: 'Adult Group Lessons (18+)', fr: 'Cours de groupe adultes (18+)' },
      description: {
    ...
    retired: {
      title: { en: 'Daytime Adult & Retired', fr: 'Cours de jour adultes et retraités' },
      description: {
  ...
  testimonials: {
    ...
    subtitle: { en: 'Trusted by Families Across the Community', fr: 'La confiance des familles de toute la communauté' },
    items: [
      {
        quote: {
          en: "My daughter has flourished under Marie-Claire's guidance. The patience and expertise shown by all the teachers is remarkable. We couldn't be happier with our choice.",
          fr: "Ma fille s'est épanouie sous la direction de Marie-Claire. La patience et l'expertise démontrées par tous les professeurs sont remarquables. Nous ne pourrions être plus satisfaits de notre choix."
        },
        author: { en: 'Sophie M., Parent', fr: 'Sophie M., Parent' },
        child: { en: "Mother of Emma, 9 years old", fr: "Mère d'Emma, 9 ans" },
      },
      {
        quote: {
        ...
        child: { en: 'Father of Lucas, 12 years old', fr: 'Père de Lucas, 12 ans' },
      },
      {
        quote: {
          en: "As an adult learner, I was nervous about starting piano lessons. Alexandre made me feel welcome from day one, and now I look forward to every lesson. It's never too late to learn!",
          fr: "En tant qu'adulte apprenant, j'étais nerveuse à l'idée de commencer les cours de piano. Alexandre m'a fait sentir bienvenue dès le premier jour, et maintenant j'attends chaque cours avec impatience. Il n'est jamais trop tard pour apprendre!"
        },
        author: { en: 'Catherine L., Adult Student', fr: 'Catherine L., Étudiante adulte' },
        child: { en: 'Adult beginner, 45 years old', fr: 'Débutante adulte, 45 ans' },
      },
    ],
  },
  contact: {
    title: { en: 'Contact Us', fr: 'Contactez-nous' },
    subtitle: { en: 'Begin Your Musical Journey Today', fr: 'Commencez votre parcours musical aujourd\'hui' },
    form: {
      ...
      submit: { en: 'Send Inquiry', fr: 'Envoyer la demande' },
      success: { en: 'Thank you! We will be in touch soon.', fr: 'Merci! Nous vous contacterons bientôt.' },
    },
    info: {
      ...
      hoursDetail: { en: 'Mon-Fri: 9AM-8PM\nSat: 9AM-5PM\nSun: Closed', fr: 'Lun-Ven: 9h-20h\nSam: 9h-17h\nDim: Fermé' },
    },
  },
  footer: {
    tagline: { en: 'Excellence in Piano Education', fr: "L'excellence en enseignement du piano" },
    quickLinks: { en: 'Quick Links', fr: 'Liens rapides' },
    programs: { en: 'Programs', fr: 'Programmes' },
    contactInfo: { en: 'Contact Info', fr: 'Coordonnées' },
    followUs: { en: 'Follow Us', fr: 'Suivez-nous' },
    copyright: { en: '© 2024 Piano à Tempo. All rights reserved.', fr: '© 2024 Piano à Tempo. Tous droits réservés.' },
  },
  policy: {
  ...
  faq: {
    ...
    items: [
      {
        q: { en: 'What age can my child start piano lessons?', fr: 'À quel âge mon enfant peut-il commencer les cours de piano?' },
        a: { en: 'We accept students from age 5 and up. For children under 7, we recommend our introductory private lessons to build foundational skills before joining group sessions.', fr: "Nous acceptons les élèves à partir de 5 ans. Pour les enfants de moins de 7 ans, nous recommandons nos cours privés d'introduction pour développer les compétences fondamentales avant de rejoindre les sessions de groupe." },
      },
      {
        q: { en: 'Do I need a piano at home?', fr: 'Ai-je besoin d\'un piano à la maison?' },
        a: { en: 'Yes, regular practice at home is essential for progress. A quality digital piano or acoustic piano is recommended. We can provide guidance on purchasing or renting an instrument.', fr: "Oui, la pratique régulière à la maison est essentielle pour progresser. Un piano numérique de qualité ou un piano acoustique est recommandé. Nous pouvons vous guider dans l'achat ou la location d'un instrument." },
      },
      {
        q: { en: 'How long are the lessons?', fr: 'Quelle est la durée des cours?' },
        a: { en: 'Private lessons are 30, 45, or 60 minutes depending on the student\'s level. Group lessons are 60 minutes.', fr: "Les cours privés sont de 30, 45 ou 60 minutes selon le niveau de l'élève. Les cours de groupe sont de 60 minutes." },
      },
      {
        q: { en: 'Do you prepare students for examinations?', fr: 'Préparez-vous les élèves aux examens?' },
        a: { en: 'Yes, we prepare students for Royal Conservatory of Music (RCM) examinations and other recognized certification programs. Many of our students have achieved distinction at various levels.', fr: "Oui, nous préparons les élèves aux examens du Conservatoire Royal de Musique (RCM) et à d'autres programmes de certification reconnus. Beaucoup de nos élèves ont obtenu des distinctions à divers niveaux." },
      },
      {
        q: { en: 'Are there performance opportunities?', fr: 'Y a-t-il des opportunités de performance?' },
        a: { en: 'Absolutely! We hold two annual recitals (winter and spring) where all students are encouraged to perform. We also participate in local music festivals and competitions.', fr: "Absolument! Nous organisons deux récitals annuels (hiver et printemps) où tous les élèves sont encouragés à se produire. Nous participons également à des festivals de musique locaux et à des concours." },
      },
    ],
  },
  gallery: {
    title: { en: 'Gallery', fr: 'Galerie' },
    subtitle: { en: 'Moments from Our Musical Community', fr: 'Moments de notre communauté musicale' },
    comingSoon: { en: 'Photo gallery coming soon. Check back for images of our recitals, lessons, and events.', fr: 'Galerie photo à venir. Revenez pour des images de nos récitals, cours et événements.' },
  },
  resources: {
    title: { en: 'Resources', fr: 'Ressources' },
    subtitle: { en: 'Tools and Materials for Your Practice', fr: 'Outils et matériaux pour votre pratique' },
    comingSoon: { en: 'Resource downloads coming soon. We are preparing practice sheets, music theory guides, and recommended reading lists for our students.', fr: 'Téléchargements de ressources à venir. Nous préparons des feuilles de pratique, des guides de théorie musicale et des listes de lecture recommandées pour nos élèves.' },
  },
};
